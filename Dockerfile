...
RUN python3 -m pip install --upgrade pip setuptools wheel \
    ...
    && python3 -m pip check \
    && python3 -c "import einops, kernels, peft, torch, torchvision, torchaudio; from transformers.models.qwen3_vl.video_processing_qwen3_vl import Qwen3VLVideoProcessor; print(f'PyTorch runtime ready: torch={torch.__version__}, torchvision={torchvision.__version__}, torchaudio={torchaudio.__version__}')"
